...
public class PaintBoard extends JFrame implements ActionListener,ChangeListener {
...
public DrawPanel() {
	...
	// Font
	jDialog = new JDialog(PaintBoard.this, "请选择文字、字型、大小与属性", true);
